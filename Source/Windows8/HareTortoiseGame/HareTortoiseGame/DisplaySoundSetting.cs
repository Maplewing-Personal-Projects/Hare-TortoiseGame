...
namespace HareTortoiseGame.PackageScene
{
    public class DisplaySoundSetting : Scene
    {
                ...
                new DrawState(game, new Vector4(2f, 0f, 1f, 1f), Color.Gray))
        {
            ...
            _sound.Content = "音效: " + SettingParameters.SoundVolume.ToString() + "%";
            ...
            _music.Content = "音樂: " + SettingParameters.MusicVolume.ToString() + "%";
        ...
        {
            _sound.Content = "音效: " + SettingParameters.SoundVolume.ToString() + "%";
            if (_soundAdd.IsHit() && SettingParameters.SoundVolume < 100)
            {
                _soundAddHover = false;
                _click.Play();
                ...
                SettingParameters.SoundVolume += 10;
            }
            ...
            if (_soundMinus.IsHit() && SettingParameters.SoundVolume > 0)
            {
                _soundMinusHover = false;
                _click.Play();
            ...
            _music.Content = "音樂: " + SettingParameters.MusicVolume.ToString() + "%";
            if (_musicAdd.IsHit() && SettingParameters.MusicVolume < 100)
            {
                _click.Play();
                ...
                SettingParameters.MusicVolume += 10;
            }
            ...
            if (_musicMinus.IsHit() && SettingParameters.MusicVolume > 0)
            {
                _click.Play();
