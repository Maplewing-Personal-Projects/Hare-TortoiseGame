    ...
    public class BoardData
    {
        ...
        public BoardData( ulong hare = 0, ulong tortoise = 0 )
        {
            ...
            if (hare == 0)
            {
                ...
                {
                    Hare <<= SettingParameters.MaxEdgeCount;
                    Hare |= 1;
                }
            }
            ...
            if (Tortoise == 0)
            {
                ...
                Tortoise <<= (SettingParameters.MaxEdgeCount * SettingParameters.MaxEdgeCount) - (SettingParameters.MaxEdgeCount - 1);
            }
        }
        ...
        public BoardData(Chess[] tortoise, Chess[] hare)
        {
            ...
            for (int i = 0; i < SettingParameters.MaxEdgeCount - 1; ++i)
            {
                if (!tortoise[i].GoalArrived) Tortoise |= 1u << (tortoise[i].Y * SettingParameters.MaxEdgeCount + tortoise[i].X);
            }

            Hare = 0;
            for (int i = 0; i < SettingParameters.MaxEdgeCount - 1; ++i)
            {
                if (!hare[i].GoalArrived) Hare |= 1u << (hare[i].Y * SettingParameters.MaxEdgeCount + hare[i].X);
            }
        }
